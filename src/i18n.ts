...
const resources = {
  en: {
    translation: {
      ...
      files: { title: "Translate files", subtitle: "Document structure and formatting are retained where the format permits.", drop: "Drop a file here or choose a file", supported: "DOCX, PPTX, XLSX, TXT, Markdown, HTML, CSV, JSON, SRT, VTT, PNG, JPG and WebP", choose: "Choose file", action: "Translate file", working: "Submitting...", download: "Download translation", mode: "Output format", translatedOnly: "Translation only", bilingual: "Original + translation", jobs: "Translation jobs", progress: "Progress", queued: "Queued", preparing: "Preparing", translating: "Translating", packing: "Building file", completed: "Completed", failed: "Failed", segments: "{{done}} / {{total}} segments", batches: "{{done}} / {{total}} batches", skipped: "{{count}} skipped", noJobs: "No file jobs", downloadBusy: "File is not ready", refresh: "Refreshing" },
      ...
      settings: { title: "Settings", subtitle: "Network, language and local web access.", language: "Interface language", proxy: "Proxy URL", proxyHint: "HTTP, HTTPS, SOCKS5 or SOCKS5H. Leave empty for a direct connection.", webAccess: "Web access", address: "Listening address", port: "Port", webHint: "Restart Tranova after changing the web address.", chunk: "Maximum characters per file translation batch", chunkHint: "The approximate source-character limit for one AI request. Smaller values preserve more context boundaries.", concurrency: "Maximum concurrent AI requests", concurrencyHint: "Text translation has priority over file batches when a request slot becomes available.", timeout: "AI request timeout (seconds)", timeoutHint: "Maximum time to wait for one AI request, including local model generation.", version: "Version", restart: "Server address changes take effect after restart." },
  ...
  "zh-CN": {
    translation: {
      ...
      files: { title: "文件翻译", subtitle: "在格式允许时保留文档结构与排版。", drop: "将文件拖到此处，或选择文件", supported: "支持 DOCX、PPTX、XLSX、TXT、Markdown、HTML、CSV、JSON、SRT、VTT、PNG、JPG 和 WebP", choose: "选择文件", action: "翻译文件", working: "正在提交…", download: "下载译文", mode: "输出形式", translatedOnly: "仅包含译文", bilingual: "原文 + 译文", jobs: "翻译任务", progress: "进度", queued: "排队中", preparing: "准备中", translating: "翻译中", packing: "正在生成文件", completed: "已完成", failed: "失败", segments: "片段 {{done}} / {{total}}", batches: "批次 {{done}} / {{total}}", skipped: "跳过 {{count}} 个", noJobs: "暂无文件任务", downloadBusy: "文件尚未完成", refresh: "刷新中" },
      ...
      settings: { title: "设置", subtitle: "配置网络、界面语言和本地 Web 访问。", language: "界面语言", proxy: "代理地址", proxyHint: "支持 HTTP、HTTPS、SOCKS5 和 SOCKS5H；留空时直连。", webAccess: "Web 访问", address: "监听地址", port: "端口", webHint: "Web 地址修改后需重启 Tranova。", chunk: "单个文件翻译批次最大字符数", chunkHint: "单次 AI 请求的近似原文字符上限；较小值可以保留更多上下文边界。", concurrency: "AI 最大并发请求数", concurrencyHint: "有请求槽位空闲时，文本翻译优先于文件批次。", timeout: "AI 请求超时（秒）", timeoutHint: "单次 AI 请求允许等待的最长时间，包括本地模型生成时间。", version: "版本", restart: "服务器地址修改后将在重启时生效。" },
