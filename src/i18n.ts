...
const resources = {
  en: {
    translation: {
      nav: { translate: "Translate", files: "Files", glossaries: "Glossaries", prompts: "Prompts", providers: "AI providers", settings: "Settings" },
      ...
      translate: { title: "Translate text", subtitle: "Translate with a selected AI, prompt and terminology set.", source: "Source", target: "Translation", sourceLanguage: "Source language", targetLanguage: "Target language", detect: "Auto detect", provider: "AI provider", prompt: "Prompt", glossaries: "Glossaries", placeholder: "Enter or paste text", action: "Translate", working: "Translating...", copy: "Copy result", copied: "Copied", characters: "{{count}} chars" },
      ...
      languages: { en: "English", zh: "Chinese", ja: "Japanese", ko: "Korean", fr: "French", de: "German", es: "Spanish", ru: "Russian", auto: "Auto detect" }
    },
  },
  "zh-CN": {
    translation: {
      nav: { translate: "文本翻译", files: "文件翻译", glossaries: "词汇表", prompts: "提示词", providers: "AI 服务", settings: "设置" },
      ...
      translate: { title: "文本翻译", subtitle: "使用指定的 AI、提示词和术语翻译内容。", source: "原文", target: "译文", sourceLanguage: "源语言", targetLanguage: "目标语言", detect: "自动检测", provider: "AI 服务", prompt: "提示词", glossaries: "词汇表", placeholder: "输入或粘贴需要翻译的内容", action: "翻译", working: "翻译中…", copy: "复制译文", copied: "已复制", characters: "{{count}} 个字符" },
      ...
      languages: { en: "英语", zh: "中文", ja: "日语", ko: "韩语", fr: "法语", de: "德语", es: "西班牙语", ru: "俄语", auto: "自动检测" }
    },
  },
} as const;
